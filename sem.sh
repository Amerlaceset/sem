...
cp $HOME/payload5.zip

cp $HOME/payload5

cp $HOME/../usr/bin/payload.sh

cp $HOME/../usr/bin/payload

cp $HOME/../usr/bin/setup5.sh
...
echo -e ' .e$$$$e.'$cyan ' Welcome to----->{'$green'2019'$cyan'}'$red
...
echo -e ' $$$$$$$$$$$$$$'" Eslam Nassar"" & $green Amerr $blue &"
...
echo -e "$blue| [4] ngrok 🌐 | $red [5] virus ☢️️| $reset [6] Termux 📟 | "
